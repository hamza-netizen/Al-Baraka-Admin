...
export class CategoryService {
  ...
  getAllPaged(MasterFilter?: string | undefined, sorting?: string | null | undefined, skipCount?: number | undefined, maxResultCount?: number | undefined): Observable<IResultDto<ICategoryDto>> 
  {
    let url_ = '/api/services/app/Category/GetAllPaged?';
    ...
    return this.http.get<IRootObjectDto<ICategoryDto>>(url_).pipe(map(x=>x.result));
  }

  getForEdit(Id: number | undefined): Observable<ICategoryDto> {


    let url_ = '/api/services/app/Category/GetForEdit?';
        if (Id === null) throw new Error("The parameter 'id' cannot be null.");
        else if (Id !== undefined)
          url_ += 'Id=' + encodeURIComponent('' + Id) + '&';
        url_ = url_.replace(/[?&]$/, '');

        return this.http.get<IResultDto<ICategoryDto>>(url_).pipe(map(result => result.result));
        
  }

  addOrEdit(body: ICategoryDto | undefined): Observable<ICategoryDto> {

    console.log(body);
    let url_ = '/api/services/app/Category/AddOrEdit';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.post<ICategoryDto>(url_, jsonBody,{'headers':headers})
  }

  remove(id: number | undefined): Observable<void> {
    let url_ = "/api/services/app/Category/Remove?";
          if (id === null)
...
//     let url_ = "/api/services/app/Category/GetCountriesToExcel?";
//     if (filter === null)
