...
export class VenueService {
  ...
  getAllPaged(MasterFilter?: string | undefined, sorting?: string | null | undefined, skipCount?: number | undefined, maxResultCount?: number | undefined): Observable<IResultDto<IVenueDto>> 
  {
    let url_ =  '/api/services/app/Venue/GetAllPaged?';
    ...
    return this.http.get<IRootObjectDto<IVenueDto>>(url_).pipe(map(x=>x.result));
  }

  getForEdit(Id: number | undefined): Observable<IVenueDto> {


    let url_ =  '/api/services/app/Venue/GetForEdit?';
        if (Id === null) throw new Error("The parameter 'id' cannot be null.");
        else if (Id !== undefined)
          url_ += 'Id=' + encodeURIComponent('' + Id) + '&';
        url_ = url_.replace(/[?&]$/, '');

        return this.http.get<IResultDto<IVenueDto>>(url_).pipe(map(result => result.result));
        
  }

  addOrEdit(body: IVenueDto | undefined): Observable<IVenueDto> {

    console.log(body);
    let url_ =  '/api/services/app/Venue/AddOrEdit';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.post<IVenueDto>(url_, jsonBody,{'headers':headers})
  }

  remove(id: number | undefined): Observable<void> {
    let url_ =  "/api/services/app/Venue/Remove?";
          if (id === null)
...
//     let url_ =  "/api/services/app/Venue/GetCountriesToExcel?";
//     if (filter === null)
