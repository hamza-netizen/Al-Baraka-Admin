...
export class VoucherService {
  ...
  getAllPaged(MasterFilter?: string | undefined, sorting?: string | null | undefined, skipCount?: number | undefined, maxResultCount?: number | undefined): Observable<IResultDto<IVoucherDto>> 
  {
    let url_ =  '/api/services/app/Voucher/GetAllPaged?';
    ...
    return this.http.get<IRootObjectDto<IVoucherDto>>(url_).pipe(map(x=>x.result));
  }

  getForEdit(Id: number | undefined): Observable<IVoucherDto> {


    let url_ =  '/api/services/app/Voucher/GetForEdit?';
        if (Id === null) throw new Error("The parameter 'id' cannot be null.");
        else if (Id !== undefined)
          url_ += 'Id=' + encodeURIComponent('' + Id) + '&';
        url_ = url_.replace(/[?&]$/, '');

        return this.http.get<IResultDto<IVoucherDto>>(url_).pipe(map(result => result.result));
        
  }

  addOrEdit(body: IVoucherDto | undefined): Observable<IVoucherDto> {

    console.log(body);
    let url_ =  '/api/services/app/Voucher/AddOrEdit';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.post<IVoucherDto>(url_, jsonBody,{'headers':headers})
  }

  remove(id: number | undefined): Observable<void> {
    let url_ =  "/api/services/app/Voucher/Remove?";
          if (id === null)
...
//     let url_ =  "/api/services/app/Voucher/GetCountriesToExcel?";
//     if (filter === null)
