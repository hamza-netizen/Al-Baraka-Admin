...
import { MultiLingualEditorComponent, MultiLingualEditorTranslationDirective } from '@shared/translation-editor/multi-lingual-editor.component';
...
export class AppCommonModule {
    static forRoot(): ModuleWithProviders<AppCommonModule> {
        return {
            ...
            providers: [AppAuthService, AppRouteGuard, MultiLingualModelService],
        };
    }
}
